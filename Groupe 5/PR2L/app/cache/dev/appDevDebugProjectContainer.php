...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->parameters = array(
            ...
            'session.save_path' => 'C:/wamp/www/Projet-tuteur-S3/Groupe 5/PR2L/app/cache/dev/sessions',
            ...
            'profiler.storage.dsn' => 'file:C:/wamp/www/Projet-tuteur-S3/Groupe 5/PR2L/app/cache/dev/profiler',
            ...
            'router.resource' => 'C:/wamp/www/Projet-tuteur-S3/Groupe 5/PR2L/app/cache/dev/assetic/routing.yml',
            ...
            'debug.container.dump' => 'C:/wamp/www/Projet-tuteur-S3/Groupe 5/PR2L/app/cache/dev/appDevDebugProjectContainer.xml',
            ...
            'twig.options' => array(
                ...
                'cache' => 'C:/wamp/www/Projet-tuteur-S3/Groupe 5/PR2L/app/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.default.memory.path' => 'C:/wamp/www/Projet-tuteur-S3/Groupe 5/PR2L/app/cache/dev/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => 'C:/wamp/www/Projet-tuteur-S3/Groupe 5/PR2L/app/cache/dev/assetic',
            ...
            'assetic.read_from' => 'C:/wamp/www/Projet-tuteur-S3/Groupe 5/PR2L/app/../web',
            'assetic.write_to' => 'C:/wamp/www/Projet-tuteur-S3/Groupe 5/PR2L/app/../web',
            ...
            'doctrine.orm.proxy_dir' => 'C:/wamp/www/Projet-tuteur-S3/Groupe 5/PR2L/app/cache/dev/doctrine/orm/Proxies',
        ...
        $this->methodMap = array(
            ...
            'pr2l_menu.manager' => 'getPr2lMenu_ManagerService',
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), 'C:/wamp/www/Projet-tuteur-S3/Groupe 5/PR2L/app/cache/dev/annotations', true);
    }
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, 'C:/wamp/www/Projet-tuteur-S3/Groupe 5/PR2L/app/Resources');
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => (dirname(dirname(dirname(__DIR__))).'\\src\\PR2L\\UserBundle\\Entity'), 1 => (dirname(dirname(dirname(__DIR__))).'\\src\\PR2L\\MenuBundle\\Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'PR2L\\UserBundle\\Entity');
        $c->addDriver($b, 'PR2L\\MenuBundle\\Entity');

        $d = new \Doctrine\ORM\Configuration();
        $d->setEntityNamespaces(array('PR2LUserBundle' => 'PR2L\\UserBundle\\Entity', 'PR2LMenuBundle' => 'PR2L\\MenuBundle\\Entity'));
        $d->setMetadataCacheImpl($this->get('doctrine_cache.providers.doctrine.orm.default_metadata_cache'));
        $d->setQueryCacheImpl($this->get('doctrine_cache.providers.doctrine.orm.default_query_cache'));
        $d->setResultCacheImpl($this->get('doctrine_cache.providers.doctrine.orm.default_result_cache'));
        $d->setMetadataDriverImpl($c);
        $d->setProxyDir('C:/wamp/www/Projet-tuteur-S3/Groupe 5/PR2L/app/cache/dev/doctrine/orm/Proxies');
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_e3d92a063b3f9e15826676b43bb21fa71ed5b1e42492be67a168bf7bc3882ead');
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), 'C:/wamp/www/Projet-tuteur-S3/Groupe 5/PR2L/app/Resources');
    }
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('C:/wamp/www/Projet-tuteur-S3/Groupe 5/PR2L/app/logs/dev.log', 100, true);
    }
    ...
    /**
     * Gets the 'pr2l_menu.manager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \PR2L\MenuBundle\Utility\MenuManager A PR2L\MenuBundle\Utility\MenuManager instance.
     */
    protected function getPr2lMenu_ManagerService()
    {
        return $this->services['pr2l_menu.manager'] = new \PR2L\MenuBundle\Utility\MenuManager();
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:C:/wamp/www/Projet-tuteur-S3/Groupe 5/PR2L/app/cache/dev/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, 'C:/wamp/www/Projet-tuteur-S3/Groupe 5/PR2L/app/cache/dev/assetic/routing.yml', array('cache_dir' => 'C:/wamp/www/Projet-tuteur-S3/Groupe 5/PR2L/app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appDevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appDevUrlMatcher', 'strict_requirements' => true, 'resource_type' => 'yaml'), $this->get('router.request_context', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('monolog.logger.router', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('C:/wamp/www/Projet-tuteur-S3/Groupe 5/PR2L/app/cache/dev/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        $this->services['sensio_distribution.webconfigurator'] = $instance = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('C:/wamp/www/Projet-tuteur-S3/Groupe 5/PR2L/app');
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('C:/wamp/www/Projet-tuteur-S3/Groupe 5/PR2L/app/cache/dev/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, 'C:/wamp/www/Projet-tuteur-S3/Groupe 5/PR2L/app', 'UTF-8');
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, 'C:/wamp/www/Projet-tuteur-S3/Groupe 5/PR2L/app', 'UTF-8'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('C:/wamp/www/Projet-tuteur-S3/Groupe 5/PR2L/app/Resources/views');
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), 'C:/wamp/www/Projet-tuteur-S3/Groupe 5/PR2L/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('C:/wamp/www/Projet-tuteur-S3/Groupe 5/PR2L/app/cache/dev/assetic/assets');
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), 'C:/wamp/www/Projet-tuteur-S3/Groupe 5/PR2L/app/cache/dev');
    }
