...
\t\t\tsrc=\"";
        // line 24
        echo twig_escape_filter($this->env, (($this->env->getExtension('assets')->getAssetUrl("images/nb/") . (isset($context["nb1"]) ? $context["nb1"] : null)) . ".jpg"), "html", null, true);
        echo "\" alt='numero' /> + <img
\t\t\tsrc=\"";
        // line 25
        echo twig_escape_filter($this->env, (($this->env->getExtension('assets')->getAssetUrl("images/nb/") . (isset($context["nb2"]) ? $context["nb2"] : null)) . ".jpg"), "html", null, true);
        echo "\" alt='numero' /> =
\t</p>

\t<input type=\"hidden\" name=\"nb1\" value=\"";
        // line 28
        echo twig_escape_filter($this->env, (isset($context["nb1"]) ? $context["nb1"] : null), "html", null, true);
        echo "\" /> 
\t<input type=\"hidden\" name=\"nb2\" value=\"";
        // line 29
        echo twig_escape_filter($this->env, (isset($context["nb2"]) ? $context["nb2"] : null), "html", null, true);
        echo "\" /> <br /> 
\t
