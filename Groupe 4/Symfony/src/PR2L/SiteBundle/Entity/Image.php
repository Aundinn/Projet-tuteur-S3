 ...
 * @ORM\Entity(repositoryClass="PR2L\SiteBundle\Entity\ImageRepository")
...
class Image
{
     ...
     * @var string
     *
     * @ORM\Column(name="rendu", type="string", length=255)
     */
    private $rendu;
    ...
    {
        return 'bundles/pr2lsite/images/images_articles';
    }
