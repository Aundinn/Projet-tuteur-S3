...
/* PR2LSiteBundle:Default:partenaires.html.twig */
class __TwigTemplate_9e2e626d22a00068067740f1cd6c878f4fb93d79b2c4a243d5aa7f2e5eaefdac extends Twig_Template
{
    ...
    {
        // line 6
        echo "<article id=\"CRESS\">
\t<h1>La Chambre Régionale de l’Economie Sociale et Solidaire du Limousin (CRESS)</h1>
\t<a href=\"http://www.creslimousin.org/\">
\t\t<img src=\"";
        // line 9
        echo twig_escape_filter($this->env, $this->env->getExtension('assets')->getAssetUrl("bundles/pr2lsite/images/cress_limousin.gif"), "html", null, true);
        echo "\" id=\"logoCRESS\" class=\"logoPartenaires\">
\t</a>
...
\t<p>La Chambre Régionale de l’Economie Sociale et Solidaire du Limousin (CRESS) est une association sans but lucratif créée en 2001 dont l’objet est de promouvoir l’économie sociale et solidaire en Limousin.statuts Historiquement la CRESS a pour ancêtre le Groupement Régional des Coopératives (GRC) fondé en 1969 auquel s’est rajoutée la famille des mutuelles de santé et d’assurances pour former le GRCM. En 1987, la famille associative rejoint le GRCM pour former le GRCMA qui en 1995 devient le GRCMA-CRES.</p>
</article>
...
\t<p>L’Institut mobilise ses atouts et ses compétences pour donner à connaître aux salariés l’histoire sociale et singulièrement la longue expérience de la CGT.</p>

\t<p>Son action est diversifiée. En premier lieu l’Institut se consacre à la sauvegarde, au classement et à la valorisation des archives de la Confédération. Cela le conduit à ouvrir les archives à l’étude et à la recherche ainsi qu’à organiser des conférences, séminaires et colloques seul ou en coopération avec des universitaires et des chercheurs.</p>
</article>
...
\t<img src=\"";
        // line 29
        echo twig_escape_filter($this->env, $this->env->getExtension('assets')->getAssetUrl("bundles/pr2lsite/images/logo_credit_cooperation.gif"), "html", null, true);
        echo "\" id=\"logoCCFCC\" class=\"logoPartenaires\">
...
\t</p>
\t<p>La Mutualité Française Limousin est l'Union régionale de la Mutualité Française dans la région.</p>

\t<p>Premier mouvement social du pays, la Mutualité Française fédère 95 % des mutuelles santé en France. Au total, 38 millions de personnes – plus d'un Français sur deux – sont protégées par une mutuelle de la Mutualité Française.</p>

\t<p>Acteur incontournable de la politique de santé en France, la Mutualité Française participe activement au maintien d'une protection sociale solidaire et à l'évolution de notre système de santé.</p>
</article>
<article id=\"CEDIAS\">
\t<h1>CEDIAS</h1>
...
\t<p>Ces conférences et colloques sont ouverts à tous publics mais les séminaires sont principalement destinés aux chercheurs et acteurs de l'action sociale.</p>
</article>
<article id=\"CODHOS\">
\t<h1>CODHOS</h1>
...
\t</a>
\t<p>
\t\tLe CIRIEC-France a été créé en 1950 avec le concours de Léon Jouhaux, Paul Ramadier et Gabriel Ventejol. Organisation non gouvernementale, le CIRIEC-France se veut être :
\t\t<ul>
\t\t\t<li>un carrefour entre les hommes, les institutions, les cultures,</li>
\t\t\t<li>un lieu de réflexion sur l'économie sociale, l'économie publique et leurs rôles dans l'économie mondiale,</li>
\t\t\t<li>un réseau réunissant les expertises et les volontés venues de tous les horizons.</li>
\t\t</ul>
\t</p>
\t<p>Branche française du CIRIEC, l'association a pour objet la promotion de la réflexion et de l'action pour le développement des initiatives d'économie publique, sociale et coopérative.</p>
\t<p>Elle regroupe des entreprises, des organisations, des femmes et des hommes impliqués dans la vie sociale, politique, ou dans l'entreprise et qui souhaitent inscrire dans les faits le principe d'économie d'intérêt général.
\t</p>
</article>
<article id=\"RECMA\">
\t<h1>RECMA</h1>
...
\t<p>Fondée en 1921 par Charles Gide et Bernard Lavergne, la Revue des études coopératives est devenue en 1986 Revue des études coopératives, mutualistes et associatives (Recma), puis Revue internationale de l’économie sociale.</p>

\t<p>Sa fonction est de susciter et diffuser des études et recherches en sciences sociales, économiques et juridiques, portant sur les organisations d’économie sociale en France, en Europe et dans le monde.</p>
</article>
<article id=\"ADDES\">
\t<h1>ADDES</h1>
...
";
    ...
    {
        return "PR2LSiteBundle:Default:partenaires.html.twig";
    }
    ...
    {
        return array (  75 => 29,  52 => 9,  47 => 6,  44 => 5,  37 => 3,  11 => 1,);
    }
}
